...
public class MinecraftSettingsFrame extends SettingsFrame {
    ...
    public MinecraftSettingsFrame() {
        ...
        appendSaveFolderFieldAction(() -> Settings.pathToMinecraftSaveFolder = getFieldSavesFolderPath().getText());
        appendBackupFolderFieldAction(() -> Settings.pathToMinecraftBackupFolder = getFieldBackupFolderPath().getText());
    }
}
